...
| `pin-row` | `bracket_pin_row.ocad.d` | linear | union | `feature:extrude_base` | `hole_diameter`, `boss_height`, `spacing_expr: hole_pitch` |
| `pin-ring` | `bracket_pin_ring.ocad.d` | circular | union | `feature:extrude_base` | `hole_diameter`, `boss_height` |
